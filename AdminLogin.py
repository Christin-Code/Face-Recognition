...
title_label = tk.Label(login_frame, text='Admin Login', font=('Times New Roman', 35), fg='#f7208c', bg="#f5faf8")
...
def login():
    ...
    users_ref = db.reference('AdminLogin')
    ...
    if user_ref.child('adpassword').get() != password:
        tk.messagebox.showerror('Error', 'Invalid username or password')
        return
