    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter < 10:
                    cv2.putText(imgBackground, str(employeeInfo['total_attendance']), (880, 125),
                                cv2.FONT_HERSHEY_COMPLEX, 1, (50, 50, 50), 1)
                    cv2.putText(imgBackground, str(employeeInfo['department']), (960, 563),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(id), (920, 512),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(employeeInfo['standing']), (910, 635),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(employeeInfo['joined_year']), (1130, 635),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
